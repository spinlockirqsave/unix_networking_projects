 ...
 *
 * Created on May 25, 2014, 2:31 PM
 */
...
dg_echo(int sockfd, SA *pcliaddr, socklen_t clilen)
{
	...
	for ( ; ; ) {
                /* we set SO_RCVBUF to higher value to make receive buffer
                 * larger in order to decrease datagram loss rate, might not work
                 * if buffer is already at limits
                 */
                n = 300 * 1024;
