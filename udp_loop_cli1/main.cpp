 ...
 *
 * Created on May 25, 2014, 1:54 PM
 */
...
#define	DGLEN	8000	/* length of each datagram */
...
dg_cli(FILE *fp, int sockfd, const SA *pservaddr, socklen_t servlen)
{
	...
	char	sendline[DGLEN];
        ...
        /* we will check how many of these datagrams will be lost
         * due to buffer size not enough to queue all  bytes */
	for ( i = 0; i < NDG; i++) {
